---
title: 'Introduce eko framework'
description: 'Eko Keeps Operating - Empowering language to transform human words into action'
pubDate: 'Dec 24 2024'
heroImage: '../../assets/images/te.jpg'
category: 'Developers'
tags: ['JavaScript', 'Agent', 'Natural Language Programming', 'Workflow', 'Computer use']
---
